        ...
        <div className="space-y-4 lg:space-y-6">
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Organize transactions by category</p>
                </div>
                <Button onClick={onCreate} size="sm">
                    <Plus size={16} /> <span className="hidden sm:inline">Add Category</span><span className="sm:hidden">Add</span>
                </Button>
            </div>
