    ...
    return (
        <div className="space-y-4 lg:space-y-6">
            <div className="flex items-start justify-between gap-3">
                <div>
                    <h1 className="text-2xl lg:text-3xl font-bold text-slate-900 tracking-tight">Budgets</h1>
                ...
                <div className="flex items-center gap-2 shrink-0">
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-2 rounded-full text-xs font-medium border border-violet-200 bg-violet-50 text-violet-700 hover:bg-violet-100 disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                        {analyzing ? <Spinner size="sm" /> : <Sparkles size={13} />}
                        <span className="hidden sm:inline">{analyzing ? 'Analyzing' : hasAnalyses ? 'Re-analyze' : 'Analyze'}</span>
                    </button>
                    <Button onClick={onCreate} size="sm">
                        <Plus size={16} /> <span className="hidden sm:inline">Add Budget</span><span className="sm:hidden">Add</span>
                    </Button>
                </div>
            </div>
