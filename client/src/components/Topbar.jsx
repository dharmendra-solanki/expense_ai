...
const Topbar = () => {
    ...
    return (
        <header className="h-14 lg:h-16 bg-white border-b border-slate-100 flex items-center justify-between px-4 lg:px-6 shrink-0">
            {/* Mobile: show logo. Desktop: show greeting */}
            <div className="flex items-center gap-2 lg:hidden">
                ...
                <span className="font-bold text-slate-900 text-sm">ExpenseAI</span>
            </div>
